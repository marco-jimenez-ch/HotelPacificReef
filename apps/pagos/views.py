...
from .utils import calcular_garantia, generar_codigo_transaccion, generar_qr_base64
...
def resumen_pago(request, reserva_id):
    ...
    return render(request, 'pagos/resumen_pago.html', {'reserva': reserva, 'garantia': garantia})
...
def comprobante_qr(request, reserva_id):
    ...
    qr_data = {
        ...
        'garantia': int(pago.monto_garantia),
        'codigo_transaccion': pago.codigo_transaccion,
    }
    qr_base64 = generar_qr_base64(qr_data)
    return render(request, 'pagos/comprobante_qr.html', {'reserva': reserva, 'pago': pago, 'qr_base64': qr_base64})
